...
(function(process) {
  !function(undefined) {
    ...
    (function(modules) {
      ...
      $def($def.S + $def.F * !__webpack_require__(81)(function(iter) {
        Array.from(iter);
      ...
      function setStatics(keys, length) {
        $.each.call(keys.split(','), function(key) {
          if (length == undefined && key in $Array)
            ...
            statics[key] = __webpack_require__(79)(Function.call, [][key], length);
        });
      }
      ...
      module.exports = function(NAME, methods, common, IS_MAP, IS_WEAK) {
        ...
        if (!$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)) {
          ...
          var inst = new C,
              ...
              buggyZero;
          if (!__webpack_require__(81)(function(iter) {
            new C(iter);
          })) {
            C = function() {
