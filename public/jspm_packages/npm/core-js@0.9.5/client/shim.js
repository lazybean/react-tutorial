  ...
  !function(undefined) {
    ...
    (function(modules) {
      ...
      var date = new Date(-5e13 - 1),
          brokenDate = !(date.toISOString && date.toISOString() == '0385-07-25T07:06:39.999Z' && __webpack_require__(61)(function() {
      ...
      var $ = __webpack_require__(47),
          cof = __webpack_require__(48),
          tmp = {};
      tmp[__webpack_require__(54)('toStringTag')] = 'z';
      if ($.FW && cof(tmp) != 'z')
      ...
      var $ = __webpack_require__(47),
          ...
          $def = __webpack_require__(50),
          toLength = $.toLength;
      $def($def.P + $def.F * !__webpack_require__(61)(function() {
        'q'.endsWith(/./);
      ...
      $def($def.S + $def.F * !__webpack_require__(69)(function(iter) {
        Array.from(iter);
      ...
      var $ = __webpack_require__(47),
          setUnscope = __webpack_require__(66),
          ITER = __webpack_require__(49).safe('iter'),
          $iter = __webpack_require__(64),
          step = $iter.step,
      ...
      var $def = __webpack_require__(50);
      $def($def.S, 'RegExp', {escape: __webpack_require__(60)(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)});
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(47),
          $def = __webpack_require__(50),
          ownKeys = __webpack_require__(76);
      ...
      function setStatics(keys, length) {
        $.each.call(keys.split(','), function(key) {
          if (length == undefined && key in $Array)
            ...
            statics[key] = __webpack_require__(67)(Function.call, [][key], length);
        });
      }
      ...
      var $ = __webpack_require__(47),
          cof = __webpack_require__(48),
          assertObject = __webpack_require__(53).obj,
          SYMBOL_ITERATOR = __webpack_require__(54)('iterator'),
      ...
      var $ = __webpack_require__(47),
          UNSCOPABLES = __webpack_require__(54)('unscopables');
      ...
      var SYMBOL_ITERATOR = __webpack_require__(54)('iterator'),
          SAFE_CLOSING = false;
      try {
      ...
      module.exports = function(NAME, methods, common, IS_MAP, IS_WEAK) {
        ...
        if (!$.isFunction(C) || !(IS_WEAK || !BUGGY && proto.forEach && proto.entries)) {
          ...
          var inst = new C,
              ...
              buggyZero;
          if (!__webpack_require__(69)(function(iter) {
            new C(iter);
          })) {
            C = function() {
